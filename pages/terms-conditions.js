            ...
            <div className="terms-conditions-area ptb-100">
                <div className="container">
                    <div className="terms-conditions-content">
                        ...
                        <p>This site is provided by <strong>Traxy</strong>. <strong>Traxy</strong> collects information in several ways from different parts of this site.</p>
                        ...
                        <p><strong>Traxy</strong> accepts the following payment methods:</p>
                        <ul>
                            ...
                            <li><strong>Traxy</strong> features a Fast Checkout option, allowing you to securely save your credit card details so that you don't have to re-enter them for future purchases.</li>
