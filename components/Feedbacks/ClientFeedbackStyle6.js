                        ...
                        <div className="col-lg-8 col-md-12">
                            ...
                            > 
                                <div className="content">
                                    ...
                                    <p>Traxy is the best digital agency in our area As a midsize software developent company we combine the best of both worlds. We have the focus and speed of the small it outsurcing companies.</p>
                                </div>
                                <div className="content">
                                    <h3>James Andy</h3>
